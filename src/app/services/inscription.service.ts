...
export class InscriptionService {
  ...
  accept_inscription(id: any): Observable<any> {
    const url = `${base_url}/accept_inscription/${id}`;
    return this.http.get(url, this.headers);
  }

  pass_inscription(id: any): Observable<any> {
    const url = `${base_url}/pass_inscription/${id}`;
    return this.http.get(url, this.headers);
  }
